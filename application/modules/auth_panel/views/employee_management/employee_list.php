...
<div class="col-sm-12">
    <section class="panel">
        <header class="panel-heading">
            <?php //echo strtoupper($page); ?> Employee(s) List
        </header>
               ...
               <script type="text/javascript" language="javascript" >
                   ...
                   jQuery(document).ready(function() {
                       ...
                       var dataTable = jQuery("#"+table).DataTable( {
                           "processing": true,
                            "pageLength": 50,
                            "lengthMenu": [[50, 100, 250], [50, 100, 'ALL']],
                           "serverSide": true,
                           "order": [[ 0, "desc" ]],
                           "ajax":{
                               url :"$adminurl"+"employee_management/employee_management/ajax_all_employee_list/", // json datasource
