    ...
    <div id="sidebar"  class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu dcjq-parent-li">
                ...
                <a href="javascript:;" class="<?php echo $employee_management; ?>">
                ...
                <ul class="sub" style="display: block;">  
                    ...
                    <li class="sub-menu <?php echo $employee_list; ?>">

                        <a class="" href="<?php echo base_url(INDEX_PHP.'admin-panel/employee-list'); ?>">
                    ...
                    <li class="sub-menu <?php echo $attendance_report; ?>">

                        <a class="" href="<?php echo base_url(INDEX_PHP.'admin-panel/attendance-report'); ?>">
            ...
            <!-- ################################ EMPLOYEE MANAGEMENT SECTION END  #################################################-->
            ...
            <li class="sub-menu dcjq-parent-li">
                ...
                <a href="javascript:;" class="<?php echo $pass; ?>">
                ...
                <ul class="sub" style="display: block;">  
                    ...
                    <li class="sub-menu <?php echo $pass_list; ?>">

                        <a class="" href="<?php echo base_url(INDEX_PHP.'admin-panel/pass-list'); ?>">
