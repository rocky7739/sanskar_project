...
class Pass_management extends MX_Controller {
    ...
    function __construct() {
        ...
        $this->load->model("Pass_management_model");
        $this->load->helper("services");
    }

    public function pass_list() {
        $data['page_title'] = "Pass List";
        $view_data['page'] = "pass_list";
        $data['page_data'] = $this->load->view('pass_management/pass_list', $view_data, TRUE);
        echo modules::run(AUTH_DEFAULT_TEMPLATE, $data);
    }

    public function ajax_all_pass_list() {
        ...
        foreach ($result as $r) {  // preparing an array
            ...
            $data[] = $nestedData;
//            "<a class='btn-xs bold btn btn-primary float-right' href='" . base_url(INDEX_PHP.'admin-panel/visitor-details/') . $r->id . "'><i class='fa fa-user'></i>Visitor Profile</a>&nbsp;"
        }
