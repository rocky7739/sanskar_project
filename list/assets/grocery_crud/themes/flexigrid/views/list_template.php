		...
		<div class="tDiv2">
			...
			<div class="fbutton">
				<div>
					...
					<button class="btn btn-xs  btn-success"><?php echo $this->l('list_add'); ?> <?php echo $subject?></button>
				</div>
			</div>
            </a>
        	...
        	<a class="export-anchor" href="<?php echo $export_url; ?>" download>
				<div class="fbutton">
					<div>
						...
						<button class="btn btn-xs btn-success btn-info"><?php echo $this->l('list_export');?></button>
					</div>
				</div>
            </a>
        	...
        	<a class="print-anchor" data-url="<?php echo $print_url; ?>">
				<div class="fbutton">
					<div>
						...
						<button class="btn btn-xs btn-success btn-info"><?php echo $this->l('list_print');?></button>
					</div>
				</div>
            </a>
			<div class="btnseparator"></div>
